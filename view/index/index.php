            ...
            <div class="col-lg-12">
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_img">
                                <img src="public/img/single_product_1.png" class="img-fluid" alt="#">
                                <img src="public/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                            </div>
                        </div>
                ...
                <div class="single_product_iner">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_img">
                                <img src="public/img/single_product_2.png" class="img-fluid" alt="#">
                                <img src="public/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-5 col-sm-6">
                ...
                <div class="single_product_iner">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-lg-6 col-sm-6">
                            <div class="single_product_img">
                                <img src="public/img/single_product_3.png" class="img-fluid" alt="#">
                                <img src="public/img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-5 col-sm-6">
...
<section class="trending_items">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <div class="single_product_item_thumb">
                        <img src="public/img/tranding_item/tranding_item_1.png" alt="#" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <img src="public/img/tranding_item/tranding_item_2.png" alt="#" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <img src="public/img/tranding_item/tranding_item_3.png" alt="#" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <img src="public/img/tranding_item/tranding_item_4.png" alt="#" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <img src="public/img/tranding_item/tranding_item_5.png" alt="#" class="img-fluid">
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="single_product_item">
                    <img src="public/img/tranding_item/tranding_item_6.png" alt="#" class="img-fluid">
