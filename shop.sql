...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1294285287ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=page_tbl">`shop`.`page_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=mainpro_tbl">`shop`.`mainpro_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=product_tbl">`shop`.`product_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=newpro_tbl">`shop`.`newpro_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=newsletter_tbl">`shop`.`newsletter_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=basket_tbl">`shop`.`basket_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=procat_tbl">`shop`.`procat_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=comments_tbl">`shop`.`comments_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=comments">`shop`.`comments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=shop&table=settings_tbl">`shop`.`settings_tbl`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="3139462a61214579696772352c4c3056">
